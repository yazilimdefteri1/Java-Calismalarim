...
public class C02_IfStatements {
    public static void main(String[] args) {
        ...
        //bir if cumlesinin daha anlasilir olmasini istiyorsanız
        // if body'sini {}  icine yazmalisiniz
        // body'yi {} icine yazmazsak da if cumlesi calisir
        //  ancak ilk ;  gordugunde if cumlesi bitmis olur


        // 24. satirdaki if  kod 15. satirdaki  if dogru olsada  calisir false olsa da calisir
        System.out.println("2.satirda calisir");
